                ...
                <div class="single__slide animation__style01 slider__fixed--height">
                    <div class="container">
                        <div class="row align-items__center">
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-15">
                                <div class="slide">
                                    <div class="slider__inner">
                                        <h2>Everything you need is here</h2>
                                        <h1>Equipments</h1>
                                        <div class="cr__btn">
										<a href="<?php echo SITE_PATH?>categories.php?id=6">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>Mobility</h1>
                                        <div class="cr__btn">
										<a href="<?php echo SITE_PATH?>categories.php?id=7">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>Clothing</h1>
                                        <div class="cr__btn">
										<a href="<?php echo SITE_PATH?>categories.php?id=5">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
