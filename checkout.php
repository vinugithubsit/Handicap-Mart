...
if(isset($_POST['submit'])){
	...
	mysqli_query($con,"insert into `order`(user_id,address,city,pincode,
...
<!-- Start Bradcaump area -->
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/cat/4.jpg) no-repeat scroll center center / cover ;">
								...
								<?php } ?>
                                    ...
                                    <div class="accordion__body">
                                        <div class="paymentinfo">
                                            ...
                                            <div class="single-method">
                                                Pay Online <input type="radio" name="payment_type" value="payu"Required/>
                                            </div>
                                        </div>
                                    </div>
