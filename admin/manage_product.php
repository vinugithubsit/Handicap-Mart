		...
		if($msg==''){
			...
			if(isset($_GET['id']) && $_GET['id']!=''){
				if($_FILES['image']['name']!=''){
					...
					description='$description',meta_title='$meta_title',meta_desc='$meta_desc',meta_keyword='$meta_keyword',best_seller='$best_seller',image='$image'
					where id='$id'";
				}else{

					$update_sql="update product set 
					categories_id='$categories_id',name='$name',mrp='$mrp',price='$price',qty='$qty',short_desc='$short_desc',
					description='$description',meta_title='$meta_title',meta_desc='$meta_desc',best_seller='$best_seller',meta_keyword='$meta_keyword'
					where id='$id'";
				}
			...
			$image=rand(111111111,999999999).'_'.$_FILES['image']['name'];	
			move_uploaded_file($_FILES['image']['tmp_name'],PRODUCT_IMAGE_SERVER_PATH.$image);
			mysqli_query($con,"insert into product(categories_id,name,mrp,price,qty,short_desc,description,best_seller,meta_title,meta_desc,meta_keyword,status,image) 
			values('$categories_id','$name','$mrp','$price','$qty','$short_desc','$best_seller','$description',
                        ...
                        <div class="card-body card-block">
                         <form method="post" enctype="multipart/form-data">
						  ...
						  <div class="form-group">
							  ...
							  id="categories_id" onchange="get_sub_cat()" >
						  ...
						  -->
						   ...
						   <div class="form-group"><label for="categories" class=" form-control-label">Qty</label>
						   <input type="text" name="qty" placeholder="Enter qty" 
						   class="form-control"required value="<?php echo $qty ?>">
						   </div>
						   
						   <div class="form-group"><label for="categories" class=" form-control-label">Image</label>
						   ...
						   <textarea name="meta_title" placeholder="Enter Meta Title" 
